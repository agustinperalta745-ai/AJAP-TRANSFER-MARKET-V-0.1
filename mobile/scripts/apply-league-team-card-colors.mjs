// OTA-safe Liga presentation: full football standings table + inline AJPA qualification zones.
...
const leagueStyles = `  leagueTableShell: { alignSelf: 'stretch', backgroundColor: 'rgba(5,13,21,0.94)', borderWidth: 1, borderColor: '#263b4d', borderRadius: 12, overflow: 'hidden' },\n  leagueTable: { alignSelf: 'stretch' },\n  leagueTableHeader: { minHeight: 30, flexDirection: 'row', alignItems: 'center', backgroundColor: '#0d1d2a', borderBottomWidth: 1, borderBottomColor: '#31495c' },\n  leagueTableRow: { minHeight: 44, flexDirection: 'row', alignItems: 'center', borderLeftWidth: 3, borderBottomWidth: 1, borderBottomColor: '#182c3b' },\n  leagueHeaderText: { color: '#8fa6b8', fontSize: 7, fontWeight: '900', textAlign: 'center', letterSpacing: 0.1 },\n  leagueCellText: { color: '#d6e1e9', fontSize: 8.5, fontWeight: '700', textAlign: 'center' },\n  leaguePosition: { color: C.white, fontWeight: '900' },\n  leagueTeamHeader: { width: 112, textAlign: 'left', paddingLeft: 5 },\n  leagueTeamCell: { width: 112, minWidth: 112, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 4 },\n  leagueTeamBadge: { marginRight: 5 },\n  leagueTeamTextWrap: { flex: 1, minWidth: 0 },\n  leagueTeamName: { color: C.white, fontSize: 8.8, fontWeight: '900' },\n  leagueZoneInline: { flexDirection: 'row', alignItems: 'center', marginTop: 2, minWidth: 0 },\n  leagueZoneDot: { width: 5, height: 5, borderRadius: 3, marginRight: 3 },\n  leagueZoneLabel: { flexShrink: 1, fontSize: 6.5, lineHeight: 8, fontWeight: '800' },\n  leagueColPosition: { width: 18 },\n  leagueColSmall: { width: 20 },\n  leagueColDiff: { width: 24 },\n  leagueColPoints: { width: 26 },\n  leaguePoints: { color: C.white, fontSize: 9, fontWeight: '900', textAlign: 'center' },\n`;
ui = ui.replace(styleAnchor, styleAnchor + leagueStyles);

for (const required of [
  's.leagueTableHeader',
  '<ClubBadge club={row.team} size={18}',
  '>PTS</Text>',
  "'Campeón + Copa 1'",
  "'Copa 1'",
  "'Copa 2'",
...
console.log('AJPA Liga: tabla completa visible sin scroll horizontal; zonas integradas con punto de color dentro de cada fila.');