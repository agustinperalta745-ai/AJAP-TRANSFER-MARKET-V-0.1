...
replaceStyle('profileButton', `width: 40, height: 40, borderRadius: 20, borderWidth: 1.2, borderColor: '#2d7fba', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(4,20,33,0.80)', shadowColor: '#168cff', shadowOpacity: 0.26, shadowRadius: 8, shadowOffset: { width: 0, height: 2 }, elevation: 5`);
