...
export default function ResultsGallery() {
 ...
 return <ImageBackground source={BG_RESULTADOS} style={s.background} imageStyle={s.backgroundImage} resizeMode="cover">
...
const s=StyleSheet.create({
 background:{flex:1},backgroundImage:{opacity:0.92},overlay:{flex:1,backgroundColor:'rgba(2,6,10,0.28)'},
 ...
 card:{backgroundColor:'rgba(25,30,37,0.88)',borderRadius:20,padding:10,flexDirection:'row',gap:8,alignItems:'center'},
 team:{flex:1,minWidth:0,minHeight:120,backgroundColor:'rgba(36,40,46,0.90)',borderRadius:14,alignItems:'center',justifyContent:'center',padding:7,gap:8},
 name:{color:'#f2f4f7',textAlign:'center',fontSize:11},scoreBox:{flex:0.9,minWidth:0,backgroundColor:'rgba(16,19,24,0.92)',borderRadius:14,alignItems:'center',justifyContent:'center',minHeight:96,padding:5,gap:8},
