...
export default function ResultsGallery() {
 ...
 return <ImageBackground source={RESULTS_BACKGROUND} style={s.background} imageStyle={s.backgroundImage} resizeMode="cover">
  <View style={s.overlay}><ScrollView style={s.root} contentContainerStyle={s.gallery}>
   <View style={s.header}><Text style={s.title}>Resultados</Text><Pressable accessibilityRole="button" accessibilityLabel="Actualizar resultados" onPress={()=>void refresh()} style={s.refresh}>{loading?<ActivityIndicator color="#fff"/>:<Text style={s.refreshText}>↻</Text>}</Pressable></View>
