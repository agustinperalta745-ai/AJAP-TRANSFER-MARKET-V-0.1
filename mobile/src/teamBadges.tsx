...
// Los escudos se descargan en HQ durante la build y quedan EMBEBIDOS en el APK.
// No dependemos de Wikipedia/GitHub en tiempo de ejecución y no volvemos a caer
// en los recortes chicos con fondo negro.
const ASSETS = {
  ajax: require('../assets/teams_hq/ajax.png'),
  as_monaco: require('../assets/teams_hq/as_monaco.png'),
  aston_villa: require('../assets/teams_hq/aston_villa.png'),
  atletico_madrid: require('../assets/teams_hq/atletico_madrid.png'),
