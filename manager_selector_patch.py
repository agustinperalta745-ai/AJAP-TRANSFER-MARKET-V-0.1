...
# Mantiene ese mismo anuncio sin menciones y agrega los emojis de ambos clubes:
# primer equipo adelante y segundo equipo al final del marcador.
import classic_result_badge_patch  # noqa: F401
