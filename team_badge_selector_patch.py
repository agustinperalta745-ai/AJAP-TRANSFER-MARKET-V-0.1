...
def apply_team_badge_selector_patch(runtime, bot):
    ...
    print("AJAP selector escudos manual-only activo: City=:mancity: + Everton=:Everton: + Tottenham=:TOT: + Villarreal=:villa: + Real Betis=:betis: + Aston Villa=:aston: + Fulham=:FUL: + Sevilla=:SEV: + Celta de Vigo=:vigo: + PSG=:PSG: + Lyon=:lyon: + Marsella=:marcella: + Atletico=:atlético: + Middlesbrough=:middle: + Bolton=:bolton:")
